  ...
  return (
    <section id="contact" className="py-16 sm:py-24 md:py-32 bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="container px-4 sm:px-6 mx-auto relative z-10">
        ...
        <div className="max-w-4xl mx-auto bg-card text-card-foreground rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row scroll-animate opacity-0 transition-all duration-1000 translate-y-8">

          {/* Left — contact details */}
          <div className="p-6 sm:p-8 md:p-12 md:w-3/5">
            <h3 className="text-xl sm:text-2xl font-bold font-serif mb-2">Get in Touch</h3>
            <p className="text-muted-foreground mb-6 sm:mb-8 text-sm md:text-base">
            ...
            <div className="space-y-4 sm:space-y-5">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-xs uppercase tracking-wider text-muted-foreground mb-0.5">Location</h4>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-xs uppercase tracking-wider text-muted-foreground mb-0.5">Call / WhatsApp</h4>
                  <a
                    href={WHATSAPP_URL}
                    target="_blank"
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-xs uppercase tracking-wider text-muted-foreground mb-0.5">Email</h4>
            ...
            <div className="mt-6 sm:mt-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full h-11 sm:h-12 px-6 sm:px-8 text-sm font-semibold shadow-md border-2 border-green-600 bg-green-600 text-white hover:bg-white hover:text-green-600 transition-all duration-200 w-full sm:w-auto animate-pulse-ring"
              >
          ...
          {/* Right — Facebook */}
          <div className="bg-secondary p-6 sm:p-8 md:p-12 md:w-2/5 flex flex-col justify-center items-center text-center border-t md:border-t-0 md:border-l border-border/40">
            <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-primary/10 flex items-center justify-center mb-4 sm:mb-6">
              <Facebook className="w-8 h-8 sm:w-10 sm:h-10 text-primary" />
            </div>
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3">Connect on Facebook</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-full h-11 sm:h-12 px-6 sm:px-8 text-sm font-semibold shadow-md border-2 border-primary bg-primary text-white hover:bg-white hover:text-primary transition-all duration-200 w-full"
            >
