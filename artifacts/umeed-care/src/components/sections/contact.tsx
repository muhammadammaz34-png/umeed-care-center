        ...
        <div className="max-w-4xl mx-auto bg-card text-card-foreground rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row scroll-animate opacity-0 transition-all duration-1000 translate-y-8">
          ...
          <div className="p-10 md:p-12 md:w-3/5">
            ...
            <p className="text-muted-foreground mb-8">
              Contact us to schedule a consultation. We are here to answer your questions and guide you on your journey toward better mobility.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium">Karachi, Sindh, Pakistan</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+923136422564" className="font-medium hover:text-primary transition-colors">0313 6422564</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:shahsahab022@gmail.com" className="font-medium hover:text-primary transition-colors">shahsahab022@gmail.com</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-secondary p-10 md:p-12 md:w-2/5 flex flex-col justify-center items-center text-center border-l border-border/40">
            ...
            <p className="text-muted-foreground mb-8 text-sm">
              Reach out to us directly through our Facebook page for the quickest response. We are happy to help.
            </p>
